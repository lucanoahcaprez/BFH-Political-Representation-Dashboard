...
- update Plesk to route the domain to the frontend (see your screenshots)
...
![Plesk - domain landing page](doc/plesk_domain_landing_page.png)

2. Select 'Regel hinzufügen' / 'Add rule'
![Plesk - rule landing page](doc/plesk_rule_landing_page.png)

3. Leave url as it is, select the 'frontend' container, select the correct port (same port as used in the deploy-remote script)
![Plesk - rule frontend](doc/plesk_rule_frontend.png)
